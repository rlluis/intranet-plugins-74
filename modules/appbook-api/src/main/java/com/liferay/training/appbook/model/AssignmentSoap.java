...
/**
 * This class is used by SOAP remote services, specifically {@link com.liferay.training.appbook.service.http.AssignmentServiceSoap}.
 *
...
public class AssignmentSoap implements Serializable {
	...
	public static AssignmentSoap toSoapModel(Assignment model) {
		...
		soapModel.setIconType(model.getIconType());
