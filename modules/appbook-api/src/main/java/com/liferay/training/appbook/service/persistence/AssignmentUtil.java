...
package com.liferay.training.appbook.service.persistence;
...
public class AssignmentUtil {
	...
	public static Assignment findByUuid_First(
		...
		throws com.liferay.training.appbook.exception.
	 ...
	 * @return the matching assignments
	 */
	public static List<Assignment> findByUserId(long userId) {
	 ...
	 * @return the range of matching assignments
	 */
	public static List<Assignment> findByUserId(
	 ...
	 * @throws NoSuchAssignmentException if a matching assignment could not be found
	 */
	public static Assignment findByUserId_First(
	 ...
	 * @return the first matching assignment, or <code>null</code> if a matching assignment could not be found
	 */
	public static Assignment fetchByUserId_First(
		long userId, OrderByComparator<Assignment> orderByComparator) {
	 ...
	 * @throws NoSuchAssignmentException if a matching assignment could not be found
	 */
	public static Assignment findByUserId_Last(
			long userId, OrderByComparator<Assignment> orderByComparator)
		throws com.liferay.training.appbook.exception.
			NoSuchAssignmentException {
	 ...
	 * @return the last matching assignment, or <code>null</code> if a matching assignment could not be found
	 */
	public static Assignment fetchByUserId_Last(
		long userId, OrderByComparator<Assignment> orderByComparator) {
	 ...
	 * @throws NoSuchAssignmentException if a assignment with the primary key could not be found
	 */
	public static Assignment[] findByUserId_PrevAndNext(
		...
		return getPersistence().findByUserId_PrevAndNext(
			assignmentId, userId, orderByComparator);
	}
