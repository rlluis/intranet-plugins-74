 ...
 * <code>com.liferay.training.appbook.model.AssignmentSoap</code>. If the method in the
 * service utility returns a
 * <code>com.liferay.training.appbook.model.Assignment</code>, that is translated to a
 * <code>com.liferay.training.appbook.model.AssignmentSoap</code>. Methods that SOAP
...
public class AssignmentServiceSoap {
	...
	public static com.liferay.training.appbook.model.AssignmentSoap
			addAssignment(
		...
		try {
			com.liferay.training.appbook.model.Assignment returnValue =
				AssignmentServiceUtil.addAssignment(
					groupId, articleId, serviceContext);

			return com.liferay.training.appbook.model.AssignmentSoap.
	...
	public static com.liferay.training.appbook.model.AssignmentSoap[]
		...
		try {
			java.util.List<com.liferay.training.appbook.model.Assignment>
				returnValue = AssignmentServiceUtil.getAssignmentsByUserId(
					userId);
